...
conda create -n reasoning_scratch_cuda python=3.11 -y \
conda activate reasoning_scratch_cuda \
pip install "torch>=2.10.0" torchvision torchaudio "tokenizers>=0.22.2" reasoning-from-scratch \
